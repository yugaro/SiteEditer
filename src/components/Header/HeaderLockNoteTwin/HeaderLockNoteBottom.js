...
import LockNoteIcon from '../../Contents/image/LockNoteIcon.png';
import './HeaderLockNoteBottom.css';


class HeaderLockNoteBottom extends React.Component {
  constructor(props) {
    super(props);
        ...
        <div className="top-containter-wrapper">
          <div className="App-header-top-containter-left2">
            <a href="https://yugaro.com/" className = "btn top-icon-wrap lockiconwrapper">
              <img alt="" src={LockNoteIcon} className="locknoteiconlabel" />
            </a>
          </div>
...
export default HeaderLockNoteBottom;
